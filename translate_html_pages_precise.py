...
class PreciseHTMLTranslator:
    ...
    def translate_main_content(self, html_content):
        ...
        try:
            ...
            # 替换原始HTML中的main标签内容
            translated_html = html_content.replace(main_content, translated_main_content)
...
def main():
    ...
    # 创建翻译器并开始翻译
    translator = PreciseHTMLTranslator(source_directory, target_directory)
